...
namespace won.Views.SuratPermohonan
{
    ...
    public partial class TanahPage : OcphPage
    {
        public TanahPage()
        {
            InitializeComponent();
        ...
        public override void Edit(PermohonanModel permohonan)
        {
            ...
            BindingContext = new TanahViewModel (permohonan);
        }
    }
    public class TanahViewModel : BaseViewModelSurat<Tanahmodel>
    {
        ...
        public TanahViewModel(PermohonanModel permohonan)
        {
            SetValue(permohonan);
        }
