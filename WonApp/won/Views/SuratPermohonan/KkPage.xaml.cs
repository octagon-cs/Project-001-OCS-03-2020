...
namespace won.Views.SuratPermohonan
{
    ...
    public class KkViewModel : BaseViewModel
    {
        public Models.SuratPermohonan.KkModel Model { get; set; } = new Models.SuratPermohonan.KkModel();
        public KkViewModel()
        {
        ...
        private async void SaveAction(object obj)
        {
            try
            {
                ...
                IsBusy = true;
                var permohonan = new PermohonanModel() { TanggalPengajuan = DateTime.Now, Data = JObject.FromObject(Model)
