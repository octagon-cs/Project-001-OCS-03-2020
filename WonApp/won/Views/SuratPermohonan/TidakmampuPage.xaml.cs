...
namespace won.Views.SuratPermohonan
{
    ...
    {
        public Models.SuratPermohonan.CeraiModel Model { get; set; } = new  Models.SuratPermohonan.CeraiModel();
        ...
        private async void SaveAction(object obj)
        {
            try
            {
                ...
                IsBusy = true;
                var permohonan = new PermohonanModel() { JenisPermohonan= PermohonanType.Tidak_Mampu, TanggalPengajuan = DateTime.Now, Data = JObject.FromObject(Model), Status = StatusPersetujuan.Baru };
